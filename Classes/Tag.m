...
properties 
    ...
    x; % position of the RFID tag (x,y)
...
methods 
    ...
    function obj = Tag(tag_position) % constructor
        
        obj.x = [tag_position(1); tag_position(2)];
     
    end
    
    
    % Compute the distance between the i-th tag and the robot
    function distance = compute_distance(obj, robot_position)
        distance = sqrt((obj.x(1) - robot_position(1))^2 + (obj.x(2) - robot_position(2))^2);
    end
